...
export type CorollaCue = "music.corolla" | "music.corolla.town" | "splash.corolla" | "splash.vault" | "splash.heart" | "music.heart.victory"; // S27: the Heart's rows (silent by default)
