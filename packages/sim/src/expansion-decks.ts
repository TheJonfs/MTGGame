...
export const EXPANSION_DECKS: Record<string, { name: string; color: string; tier: 1 | 2 | 3; archetype: "aggro" | "midrange" | "control"; decklist: ExpansionDecklist }> = {
  ...
  // S20 (ADR-079, Chris-ruled): the 4× lifelink-deathtouch-flying core diluted to 3×, a removal spell traded
  // for a body (was 4 Nighthawk / 3 Child / 2 Rats / 2 Doom Blade). Identity intact, nut draws softened.
  nighthawk: { name: "A Vampire Nighthawk", color: "B", tier: 2, archetype: "midrange", decklist: d([["swamp", 12], ["vampire_nighthawk", 3], ["child_of_night", 4], ["typhoid_rats", 3], ["indulgent_aristocrat", 2], ["blood_artist", 2], ["doom_blade", 1], ["mind_rot", 2], ["tendrils_of_corruption", 1]]) },
  ...
  // S19 (ADR-078 / docs/bestiary-round-2.md): the grid-completing five.
  rats: { name: "A Plague of Rats", color: "B", tier: 1, archetype: "midrange", decklist: d([["swamp", 13], ["typhoid_rats", 4], ["child_of_night", 3], ["terror", 2], ["duress", 2], ["mind_rot", 2], ["phyrexian_rager", 2], ["gravedigger", 2]]) },
  ogre: { name: "A Gray Ogre", color: "R", tier: 1, archetype: "aggro", decklist: d([["mountain", 12], ["gray_ogre", 4], ["raging_goblin", 3], ["goblin_piker", 3], ["shock", 3], ["brute_force", 2], ["hill_giant", 2], ["blaze", 1]]) },
  lion: { name: "A Savannah Lion", color: "W", tier: 1, archetype: "aggro", decklist: d([["plains", 12], ["savannah_lions", 4], ["suntail_hawk", 4], ["fencing_ace", 3], ["master_decoy", 2], ["raise_the_alarm", 2], ["pacifism", 2], ["swords_to_plowshares", 1]]) },
  baloth: { name: "A Rumbling Baloth", color: "G", tier: 2, archetype: "midrange", decklist: d([["forest", 12], ["rumbling_baloth", 4], ["centaur_courser", 3], ["llanowar_elves", 3], ["grizzly_bears", 2], ["elvish_visionary", 2], ["giant_growth", 2], ["prey_upon", 2]]) },
  formation: { name: "The Faerie Formation", color: "U", tier: 3, archetype: "control", decklist: d([["island", 13], ["faerie_formation", 3], ["air_elemental", 2], ["gravitational_shift", 2], ["mist_raven", 2], ["wind_drake", 2], ["man_o_war", 2], ["essence_scatter", 2], ["counterspell", 1], ["control_magic", 1]]) },
};
