...
export function loadWorldCatalog(): import("@shandalar/world").Catalog {
  ...
  return catalogFromJson({ regions: byName("regions"), towns: byName("towns"), opponents: byName("opponents"), starters: byName("starters"), dungeons: byName("dungeons"), quests: byName("quests"), salvage: byName("salvage-pack") });
}
