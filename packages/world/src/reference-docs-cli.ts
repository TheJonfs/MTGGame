...
for (const [file, text] of [["cards.md", renderCardsReference(pool, knobs, oracle)], ["enemies.md", renderEnemiesReference(catalog, pool, knobs)], ["starters.md", renderStartersReference(catalog, pool, knobs)]] as const) {
