...
export const DECK_A_MONO_RED: { cardId: string; count: number }[] = [
  ...
  { cardId: "goblin_piker", count: 3 },
  { cardId: "hill_giant", count: 1 },
  { cardId: "lightning_bolt", count: 3 },
  { cardId: "shock", count: 2 },
  { cardId: "brute_force", count: 1 },
...
export const DECK_B_WU_SKIES: { cardId: string; count: number }[] = [
  ...
  { cardId: "savannah_lions", count: 3 },
  { cardId: "suntail_hawk", count: 1 },
  { cardId: "wind_drake", count: 1 },
  ...
  { cardId: "mind_stone", count: 2 },
  { cardId: "darksteel_myr", count: 1 },
];
