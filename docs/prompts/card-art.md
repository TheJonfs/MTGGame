# Card art prompts (ADR-052)

Card illustrations are **exempt from style.md** — do not prepend its preamble. Each custom card gets four candidates in distinct styles/compositions, specified here by the planner; Chris picks. Common constraints only: no text, no borders/frame, painterly-print-plausible (nothing photoreal or 3D-render), composition readable in a 5:4 crop, single focal figure/action unless stated.

## cunning_tactician — "Cunning Tactician" (W creature: commander who taps threats down)

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a human soldier-commander on a battlefield ridge at dawn, gold-and-white tabard, one arm extended in a decisive command, banners behind, warm rimlight."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a soldier mid-stride raising an open hand in a halt order, strong diagonal composition, motion in the cloak, limited palette of white, steel and a red accent."
3. **Watercolor storybook** — "Muted watercolor: a tactician leaning over a candlelit map table in a command tent, markers and counters on the map, thoughtful expression, soft edges, quiet cerebral mood."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: an armored tactician against a dark ground, single hard light source, calculating gaze, fine armor detail, near-monochrome with warm skin tones."

## gaean_wurm — "Gaean Wurm" (G creature, custom #2: a wurm that grows with the forests you control — trample, +1/+1 per Forest)

Written by the implementer at Chris's request (S17, after the card landed; the S18 brief assigned the entry to the planner — adjust freely). The idea to carry in every direction: the wurm *is* the forest — its size comes from the land, moss and roots on its hide, trees as the scale reference.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a colossal green wurm rearing from an old-growth forest floor, moss and ferns growing on its ridged hide, roots trailing from its coils, ancient trees dwarfed beside it, golden late-afternoon light through the canopy."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a huge wurm bursting through a treeline mid-charge, trunks splintering, earth thrown up, strong diagonal composition, limited palette of forest greens, umber and bone-white."
3. **Watercolor storybook** — "Muted watercolor: a vast wurm asleep and coiled among giant forest roots, its mossy back nearly indistinguishable from a green ridge, small deer grazing on it unaware, soft dappled light, quiet enormous mood."
4. **Woodcut print** — "Bold two-colour woodcut / linocut print: the sinuous coils of a great wurm winding between stylised tree trunks, heavy black carved line, flat forest green and cream paper, strong rhythmic pattern of coils and trunks."

## the_unwinder — "The Unwinder" (U legendary (Merfolk Wizard, Spiral Spire) — spirals and restrained warped-mana weirdness: something the wrong currents made, not a costume)

S21 Part 5 rider — the four-candidate ceremony run ahead of the S22 card session (art only; the cards themselves are S22). Entry authored by the implementer from the Chris-ruled visual seed (the Gaean Wurm precedent).

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a merfolk wizard standing waist-deep where a sea cave's tide visibly flows backward, his fins and skin patterned in slow spirals, one hand raised as a ribbon of water unwinds upward around it in a helix, cool blues and greens with a single wrong ember-red glint deep in the water, restrained uncanny weirdness."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a merfolk wizard mid-gesture pulling a breaking wave apart into an unwinding spiral, water peeling into coils around him, strong spiral composition, limited palette of deep blue, sea-green and bone-white with one red accent."
3. **Watercolor storybook** — "Muted watercolor: a merfolk wizard seated on the lowest step of a spiral sea-tower, watching the tide climb the stairs the wrong way, kelp curling in helixes at his feet, soft grey-blue light, quiet uncanny mood."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: a merfolk wizard against a dark ground, a single hard light refracted through a coil of suspended water spiraling around his shoulders, spiral markings on his skin catching the light, near-monochrome blue with warm glints."

## the_usher — "The Usher" (B legendary (Vampire Noble, Charnel Court) — a vampire duchess: haughty, magnetic, deadly; luxurious backdrop; she shows the dead in, and shows them out again)

S21 Part 5 rider — the four-candidate ceremony run ahead of the S22 card session (art only; the cards themselves are S22). Entry authored by the implementer from the Chris-ruled visual seed (the Gaean Wurm precedent).

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a vampire duchess in a candlelit palace hall receiving a line of pale translucent guests, extending one gloved hand to be kissed, opulent dark velvet and gold, red drapery, her smile gracious and utterly cold."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a vampire duchess sweeping an arm to usher shadowy figures through tall double doors, her gown's train flowing in a strong diagonal, limited palette of black, ivory and deep red."
3. **Watercolor storybook** — "Muted watercolor: a vampire duchess at the head of an immensely long banquet table set with untouched places, candelabra marching into the dark, her chin resting on laced fingers, patient and amused, quiet dread mood."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: a vampire duchess by a single candle raising a wine glass in a silent toast, luxurious jewels and a high collar catching the light, near-monochrome with deep red accents, haughty and deadly poise."

## the_warden — "The Warden" (W legendary (Treefolk Soldier, Argent Bastion) — the living wall given rank: silver bark, thorned-canopy reach, the watch that never rests)

S21 Part 5 rider — the four-candidate ceremony run ahead of the S22 card session (art only; the cards themselves are S22). Entry authored by the implementer from the Chris-ruled visual seed (the Gaean Wurm precedent).

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a towering treefolk soldier with silver-grey bark standing at parade rest atop a living rampart at first light, his upper branches spreading into a canopy of long thorns above the wall, banners tangled in his boughs, unmoving and watchful."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a silver-barked treefolk soldier snapping one great limb out like a pike to bar a gate, thorned branches fanning wide, strong horizontal composition, limited palette of silver-grey, white and moss green."
3. **Watercolor storybook** — "Muted watercolor: a bastion courtyard at night where human guards sleep at the roots of a silver-barked treefolk who stands awake, his thorn canopy sheltering them like a roof, one lantern, quiet steadfast mood."
4. **Woodcut print** — "Bold two-colour woodcut / linocut print: a treefolk soldier as a living section of fortress wall, bark grain and masonry merging into one another, thorned branches raked across the sky, heavy black carved line on cream with a silver-grey flat."

## the_stoker — "The Stoker" (R legendary (Efreet, Furnace Gate) — an efreet dealing in magic, heat, and energy; the furnace-spirit whose bargain is law)

S21 Part 5 rider — the four-candidate ceremony run ahead of the S22 card session (art only; the cards themselves are S22). Entry authored by the implementer from the Chris-ruled visual seed (the Gaean Wurm precedent).

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: an efreet of ember-red skin and blue-black smoke rising waist-up from a great furnace behind an iron gate, one hand extended palm-up offering a dancing flame as if closing a bargain, molten light from below, a hungry grin."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: an efreet raking a furnace with clawed hands as sparks stream upward into spiraling motes of raw magic, strong upward diagonal, limited palette of ember orange, soot black and one cold blue accent."
3. **Watercolor storybook** — "Muted watercolor: a vast dim furnace hall where a lone efreet leans out of the coals like a shopkeeper at his counter, elbow on the grate, heat shimmer rising, a row of small blue flames waiting like customers, wry transactional mood."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: an efreet lit only by his own inner furnace glowing through cracks in his skin, blue-black smoke coiling off his shoulders, near-monochrome ember tones, eyes like open firebox doors."

## the_sower — "The Sower" (G legendary (Dryad Shaman, Verdant Throne) — a dryad that evokes the sphinx-making: the dreamer and the dreamed)

S21 Part 5 rider — the four-candidate ceremony run ahead of the S22 card session (art only; the cards themselves are S22). Entry authored by the implementer from the Chris-ruled visual seed (the Gaean Wurm precedent).

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a serene dryad shaman in a throne-garden of giant flowers, hands raised as she shapes a great sphinx out of white petals and pale blue mist, its wings still forming, half flower and half dream, golden-green light."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a dryad mid-gesture as a spiral of seeds and leaves rises from her palm into the half-formed silhouette of a winged sphinx, strong upward spiral composition, limited palette of leaf green, white and sky blue."
3. **Watercolor storybook** — "Muted watercolor: a dryad asleep against a mossy throne, eyes closed and smiling, while above her a sphinx of drifting mist and petals takes shape exactly as she dreams it, soft dawn light, gentle uncanny mood."
4. **Woodcut print** — "Bold two-colour woodcut / linocut print: a dryad and a sphinx facing one another as mirrored figures, the dryad rooted and the sphinx winged, vines flowing from her hands into its mane, heavy black carved line, flat leaf-green and cream, formal symmetry."

## aetherbolt — "Aetherbolt" (UUR instant (custom, Chris-drafted; the Spire's arsenal) — a boomerang and a bolt stapled: return one thing, burn another. 'Aether' is only a card name (the warp stays nameless))

S21 Part 5 rider (Aetherbolt / Tainted Phoenix ride only if the five lords complete). Entry authored by the implementer from the boss doc's card entries.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: an armored knight flung backward off his feet into a swirl of dissolving blue light, unravelling into it, while a jagged red bolt cracks past him in the opposite direction to strike a distant tower, dramatic storm sky, two spells in one heartbeat."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a V-shaped double action — on one side a beast hurled back along an arc of blue rebounding force, on the other a thin red lightning bolt lancing out — strong crossing diagonals, limited palette of electric blue, vermilion and bone-white."
3. **Watercolor storybook** — "Muted watercolor: a siege stone hanging impossibly mid-air above a village wall, wrapped in a pale blue shimmer that is carrying it back the way it came, while a single fork of red lightning strikes the siege engine beyond, held-breath mood."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro composition: a spellcaster's two raised hands in darkness, one palm sending out expanding rings of cool blue force, the other loosing a single thin red bolt between the fingers, near-monochrome with the two spell colors as the only light sources."

## tainted_phoenix — "Tainted Phoenix" (BR creature (custom, Chris-drafted; the Gate's arsenal) — a phoenix that comes back wrong: it returns from the graveyard for a black price; creature type pending Chris (planner suggests Zombie Phoenix, Pyre Zombie lineage))

S21 Part 5 rider (Aetherbolt / Tainted Phoenix ride only if the five lords complete). Entry authored by the implementer from the boss doc's card entries.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a phoenix bursting upward from a smouldering barrow-grave at dusk, its flame feathers streaked through with black rot and violet decay, embers and grave-soil falling away beneath it, beautiful and wrong at once."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a phoenix exploding from a cracked grave mound in a column of fire and bone-ash, wings thrown wide, strong vertical burst composition, limited palette of ember orange, soot black and a bruised violet accent."
3. **Watercolor storybook** — "Muted watercolor: a ragged phoenix perched patiently on a charred headstone in an ashen graveyard, slow cinders dripping from its tail like candle wax, thin smoke rising, quiet expectant mood — it has done this before."
4. **Woodcut print** — "Bold two-colour woodcut / linocut print: a phoenix rising in a formal circular composition above stylised flat black flames and a row of grave markers, heavy black carved line on cream with a single ember-red flat, iconic and emblematic."

## thundersnake — "Thundersnake" (RR creature (custom, Chris-designed; the fun batch) — the Ball Lightning family at 10-life scale: a serpent OF storm, all speed and discharge, gone by nightfall; joins the pool's accidental serpent gallery)

S23 fun batch (ADR-084). Entry authored by the implementer from fun-batch-s23.md (the Gaean Wurm precedent). The idea to carry in every direction: the snake IS the lightning — a discharge that took a serpent's shape for one violent moment, already coming apart at the tail.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a great serpent made of living lightning racing low across a storm-dark plain, its body a crackling arc of white-gold electricity trailing sparks, grass scorching in its wake, thunderheads split by its passage, sense of terrible speed."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a lightning serpent striking directly toward the viewer with jaws open, its body zigzagging back into a storm cloud like a bolt frozen mid-strike, strong jagged diagonal composition, limited palette of white, storm grey and electric yellow."
3. **Watercolor storybook** — "Muted watercolor: villagers watching from a doorway as a serpent of lightning pours along the crest of a distant hill at dusk, one heartbeat of brilliance against a bruised purple sky, its tail already dissolving into sparks and rain, awed hushed mood."
4. **Woodcut print** — "Bold two-colour woodcut / linocut print: a serpent as a single jagged lightning bolt zigzagging from a stylised storm cloud to the earth, fangs at the bolt's tip, heavy black carved line on cream with a single electric-yellow flat, iconic as a storm-warning sign."

## gallows_djinn — "Gallows Djinn" (BB creature (custom, Chris-designed; the fun batch) — the Juzam homage: immense power honestly paid for, each battle costing its keeper a little blood. Chris's seed: focus on THE BARGAIN, not gallows imagery; a compositional nod to the iconic hunched-djinn piece is welcome if it lands)

S23 fun batch (ADR-084). Entry authored by the implementer from Chris's kickoff seed. The idea to carry in every direction: the deal — a vast djinn and the small mortal who bought its service, the price visible (a drop of blood, a signed chit, an open palm), the djinn's posture heavy with contained power rather than rage.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: an immense horned djinn hunched forward to fit the frame, massive shoulders and clawed hands, holding out one open palm on which a single drop of blood falls from the pricked finger of a small robed figure below, its grin knowing and patient, oppressive power held in check by contract, deep umber and sickly green-bronze skin tones."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a colossal djinn leaning down out of smoke toward a tiny mortal, one enormous claw extended for a handshake that fills half the frame, the mortal's hand bleeding where it grips, strong looming diagonal, limited palette of ink black, bone-white and a single arterial red accent."
3. **Watercolor storybook** — "Muted watercolor: a huge djinn sitting cross-legged and patient in a dim market stall like a merchant, ledger open before it, a nervous customer sliding a signed paper across the table, the djinn's long claw pinning the page, quiet dreadful-bargain mood, soft lamplight."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: a vast horned djinn hunched against a dark ground, single hard light on the ridges of its shoulders and skull, eyes glowing faintly, one claw curled at its chest holding a small blood-marked token of debt, near-monochrome with warm bronze glints, immense and unhurried."

## traumatizer — "Traumatizer" (UU creature (custom, Chris-designed; the fun batch) — mill's first face: a Nightmare flier that feeds on minds, each wound stealing memories; what it touches forgets)

S23 fun batch (ADR-084). Entry authored by the implementer from fun-batch-s23.md. The idea to carry in every direction: memory made visible and being TAKEN — pages, faces, thin ribbons of image pulled from a sleeper's head into the creature; the nightmare itself lean, winged, and quiet rather than monstrous-loud.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a lean midnight-blue nightmare with long ragged wings crouched on the bedpost of a sleeper, drawing a glowing thread of silver images — faces, doors, small remembered things — out of the sleeper's brow into its open mouth, moonlit bedroom, cold blue palette with silver light."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a winged nightmare swooping low over a fleeing scholar, talons raking not flesh but a streaming ribbon of torn pages and picture-fragments from his head, strong swooping diagonal, limited palette of deep indigo, bone-white and pale silver."
...
## the_sapphire_sage — ROUND 2 (Chris: reroll; lean into the Lorwyn-fae aesthetic — slender trickster faeries, iridescent insect wings, thorned bramble elegance, twilight violet-and-indigo palettes, sinister whimsy: pretty but predatory)

Whole-round reroll per the S23 round-2 precedent; four distinct styles, one shared register.

1. **Classical oil, twilight glade** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a slender, androgynous trickster faerie with long iridescent dragonfly wings and large luminous dark eyes, hovering above a moonlit pool in a bramble-walled glade, one thin finger drawing the water up into a reversed spiral, thorned vines curling toward him deferentially, twilight violets and deep indigo with pale glowmotes, beautiful and faintly menacing."
2. **Ink-and-gouache dream-theft** — "High-contrast ink drawing with gouache highlights: a sleek faerie wizard mid-air with wings ablur, hauling a knight's tent away in a net of gossamer while with the other hand lifting his own previous self out of the scene like a paper cutout, strong diagonal composition, limited palette of indigo, violet and moth-wing white, mischievous and unsettling."
3. **Muted watercolor, the wrong hour** — "Muted watercolor: a bramble-ringed pond at violet dusk where a thin, elegant faerie sits on a curled thorn branch above his own missing reflection, tide flowing out of the pond upward into the air in slow ribbons, tiny lights drifting, soft eerie quiet, whimsy with teeth."
4. **Stained glass** — "Stained-glass window panel: a slender winged trickster faerie framed by interlocking thorned brambles, his dragonfly wings made of many small leaded panes of violet, indigo and pale green glass, two spiraling ribbons of water rising on either side each carrying a small figure away, bold black leading, jewel-toned light."

## the_jet_witch — ROUND 2 (Chris: reroll cueing off round 1's dark surrealist oil — keep the register, vary the conceit)

Whole-round reroll; the style is the ruled direction, so all four are dark surrealist oils with distinct conceits and compositions.

1. **The shadow-book, portrait-forward** — "Dark surrealist oil painting: a gaunt woman strung with jet beads standing on a bare dreamlike moor, her long shadow falling open behind her as the pages of an enormous book whose lines are thin red veins running back up into her sleeve, jet beads orbiting her head like a small slow night sky, muted umber and violet-black with one deep red, uncanny stillness."
...
## arcane_collector — "Arcane Collector" (U creature, custom, S36: {U} 1/1 Human Wizard — {1}{U}, T: name a card, reveal one at random from your hand; if it is the named card, draw two)

S36 (ADR-121). Entry authored by the implementer from the brief's conceit: a collector of arcana who reads the hand as an inventory — the art carries the WAGER (naming what you hold, then the blind draw) and the collection (cabinets, catalogued curios, tagged scrolls), not a stage magician. No proper nouns. Mono-blue.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a slight, sharp-eyed wizard in ink-stained blue robes standing in a tall cabinet-of-curiosities library, one hand hovering over a row of face-down cards on a reading desk while the other holds up a single tagged specimen jar to the light, brass instruments and labelled drawers behind, cool blue and amber lamplight, an expression of confident calculation."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a wizard sweeping an arm across a desk so that a fan of face-down cards lifts into the air, one card turning face-up mid-flight and glowing, catalogue tags and loose pages swirling in a strong diagonal, limited palette of ink black, paper cream and a single cobalt-blue accent."
3. **Watercolor storybook** — "Muted watercolor: a small cluttered study at night where a young wizard sits cross-legged on the floor surrounded by open drawers of labelled curios, holding one face-down card to her forehead with eyes closed as if guessing it, a teacup and a sleeping cat nearby, soft blue-grey wash, quiet playful concentration."
4. **Chiaroscuro portrait** — "Dramatic chiaroscuro three-quarter portrait: an arcane collector lit by one blue lamp, half-moon spectacles, gloved fingers just lifting the corner of a face-down card on a black table, rows of catalogued vials receding into darkness behind, near-monochrome blue with warm skin tones and one glint of brass."

### arcane_collector — round 2 (S36; Chris: "nothing spoke; de-emphasize the cards themselves")

The wager without playing-card props: the collector KNOWS her inventory and bets on it blind — sealed jars, tagged drawers, a hand choosing by touch. The collection is the subject; the guess is the gesture. Four fresh styles (the Gallows Djinn round-2 precedent).

1. **Stained glass** — "Stained-glass window in the medieval style, thick black leading and jewel-toned glass: a slight wizard in blue robes standing before a tall cabinet of sealed glass jars, eyes closed, one hand resting on a single jar that glows gold while the others stay dark, catalogue tags as small pale panes, cobalt, amber and bottle-green glass."
...
## the_reeve — ROUND 2 (S40; Chris: reroll with four new styles — the seed holds: the steward of a larder in the bog, who keeps what the water took)

Round 1's four (oil / ink-and-gouache / watercolor / dark surrealist oil) rejected whole. Four registers round 1 did not use.

1. **Stained glass** — "Stained-glass window in the medieval style, thick black leading and jewel-toned glass: a tall gaunt steward in a long dark coat standing in a flat boat on stylised green-black water, a ring of pale keys in one hand and a lantern in the other, beneath the waterline rows of sleeping beasts and men in small leaded panes like shelves in a larder, moss green, bottle blue and bone-white glass with one amber lantern pane."
2. **Illuminated manuscript** — "Illuminated-manuscript miniature on vellum, flat perspective and gold leaf: a thin robed reeve with a tally-stick and a great ledger seated at the edge of a marsh, attendants in hoods hauling a pale giant up out of the reeds with ropes, fish and drowned crowns drawn small in the water, a blank ribbon curling overhead, sable, verdigris green and lapis with gold accents, marginal reed ornament behind (not a border)."
3. **Art nouveau poster** — "Art nouveau poster, flat colour and flowing line: a gaunt elegant warlock in profile with a high collar, his long coat-tails and hair flowing down into sinuous bog-water and roots that cradle the pale silhouettes of sleeping creatures, a ring of keys as a decorative motif, water-lily and bulrush ornament, muted teal, black-green and ivory with a single poison-yellow accent."
4. **Woodblock print** — "In the style of a Japanese ukiyo-e woodblock print, flat colour and crisp outline: a lean figure in a wide hat and long dark coat poling a narrow boat across a misty fen at night, a huge skeletal beast rising from the stylised water behind him on a chain, reeds and a low moon, bands of mist, restrained palette of indigo, moss green and bone white."

## the_cinquefont — "The Cinquefont" (WBRUG legendary (Elemental 7/7, the flood's capstone — ADR-131): not the flower but what the flower stood on — the plane's source, seen: five colours, none of them still; the tide of laws rises one a turn, stands whole for a turn, and washes out)

S42a (ADR-131/132). Entry authored by the implementer from the brief's lore lines (Part 5). The idea to carry: a FOUNT, five-coloured, RISING — water as a body, never a person in a costume; the cut flower's stem beneath it where a direction allows. Two registers from the flood's kept set (woodblock — the High Grounds'; stained glass — the Manafleur's fourth) beside the house oil and ink.

1. **Classical oil** — "Oil painting in the warm classical fantasy style of 1990s trading-card art: a colossal elemental made of rising water surging up out of a vast flooded plain at dawn, its towering body a braided column of five currents — milk-white, deep blue, black, ember red and green — that never settle, a suggestion of a crowned head and outspread arms in the spray at its top, the snapped stem of an enormous flower just visible beneath the surface at its base, tiny drowned rooftops around it for scale, mist and low golden light."
2. **Ink-and-gouache action** — "High-contrast ink drawing with gouache highlights: a towering spout of water bursting upward in a strong vertical spiral, five ribbons of colour twisting through the black ink of it — white, blue, black, red, green — a vast half-formed face in the crest looking down, waves radiating outward in rings and breaking over a causeway, limited palette of ink black and paper cream with the five small pure colour accents."
3. **Woodblock print** — "In the style of a Japanese ukiyo-e woodblock print, flat colour and crisp outline: a great five-coloured fountain-spirit rising from the centre of stylised deep water, its body five intertwined streams in white, indigo, black, vermilion and green curling upward into a wave-crest that forms a calm inhuman face, clawed foam at the edges, small islands with tiny buildings around the horizon, bands of mist, a restrained palette beyond the five streams."
4. **Stained glass** — "Stained-glass window in the medieval style, thick black leading and jewel-toned glass: a tall standing figure made of rising water at the centre of the window, its body five vertical streams of glass — clear white, cobalt, smoky black, ruby and emerald — braided together and flaring outward at the top like a crown of spray, concentric rings of blue water panes at its feet with five small islands set in them, formal symmetry, light pouring through."
